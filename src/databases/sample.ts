...
export const INIT_PERMISSIONS = [
  {
    ...
    "name": "Get Cinema with paginate",
    "apiPath": "/api/v1/cinemas",
    "method": "GET",
    "module": "CINEMAS",
    "createdBy": {
  ...
  },
  {
    ...
    "name": "Fetch ticket with paginate",
    "apiPath": "/api/v1/tickets",
    "method": "GET",
    "module": "RESUMES",
    "createdBy": {
  ...
  },
  {
    ...
    "name": "Fetch tickets by user",
    "apiPath": "/api/v1/tickets/by-user",
    "method": "POST",
    "module": "RESUMES",
    "createdBy": {
      "_id": "647b5108a8a243e8191855b5",
